...
✨ Inversión de Diseño: $${totalDesignAndLicensingCost.toLocaleString("es-CO")}
   • Los costos de diseño se mantienen constantes
   • Solo varía el diseño estructural según el proyecto
...
💵 DESGLOSE DE COSTOS DE DISEÑO:
   • Diseño sin IVA: $${totalDesignAndLicensingCost.toLocaleString("es-CO")}
   • Diseño con IVA: $${(totalDesignAndLicensingCost * (1 + IVA_RATE)).toLocaleString("es-CO")}
